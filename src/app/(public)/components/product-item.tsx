...
export function ProductItem({ id }: ProductItemProps) {
  return (
    <div className="group flex flex-col h-full py-4 items-center justify-between">
      ...
      <div className="flex flex-col justify-between  mt-4 w-full px-2 transition-all duration-300 ease-in-out opacity-100 group-hover:opacity-0 group-hover:translate-y-[110px]">
        <div className="p-2">
